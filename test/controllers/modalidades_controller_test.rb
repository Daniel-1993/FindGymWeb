...
class ModalidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create modalidade" do
    assert_difference('Modalidade.count') do
      post modalidades_url, params: { modalidade: { descricao: @modalidade.descricao, treinador_id: @modalidade.treinador_id } }
    end
  ...
  test "should update modalidade" do
    patch modalidade_url(@modalidade), params: { modalidade: { descricao: @modalidade.descricao, treinador_id: @modalidade.treinador_id } }
