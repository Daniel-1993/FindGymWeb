...
class TreinadorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create treinador" do
    assert_difference('Treinador.count') do
      post treinadors_url, params: { treinador: { formacao: @treinador.formacao, nomeProfessor: @treinador.nomeProfessor, telefone: @treinador.telefone } }
    end
  ...
  test "should update treinador" do
    patch treinador_url(@treinador), params: { treinador: { formacao: @treinador.formacao, nomeProfessor: @treinador.nomeProfessor, telefone: @treinador.telefone } }
